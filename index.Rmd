...
The Freddo price data for 2020 - 2018 was found through an webpage about the Freddo Index, whereas the price data for 2019 - 2023 was found using news articles from these years.
...
# Use FreddoCostWhole column to make a FreddoCostDec column, to show Freddo 
...
# Update FreddosAfforded column with rounded down values of
...
For the first visualisation, I wanted to plot the individual data points as well as a line to reflect the changes in them. I decided to make a scatterplot, with a general additive model (gam) to provide a moving average line.
...
p + geom_point(color = "springgreen4") + 
  # adds points to the scatter plot with colour set as a shade of dark green.
  geom_smooth(method = "gam", color = "purple4") + 
  # adds gam line to the scatter plot, with colour set as a shade of dark purple.
  labs(x = "Year", y = "Number of Freddos afforded with 
       Minimum Wage",
       title = "Freddos Afforded With The Minimum Wage: 
       From 2000 to 2023") + 
  # set labels for x axis, y axis and for the title of the graph
...
p + geom_line(size = 1, color = "springgreen4") + 
  # add lines to connect points, setting size and colour as a shade of dark green
  geom_point(color = "purple4", aes(size = WagePounds)) + 
  # adds points to the scatter plot with colour set as a shade of dark purple 
  # and point size dependent on WagePounds variable
...
With my final visualisation, I decided to keep the data point formatting to represent the minimum wage, but include a line of best fit instead of lines connecting the data points. I also wanted to bring an element of interactivity to the visualisation, so included the use of ggplotly.
...
p <- ggplot(data = FA_Data,
  ...
  labs(x = "Year", y = "Number of Freddos afforded with hours worth of 
       Minimum Wage",
       title = "Freddos Afforded With The Minimum Wage:
       From 2000 to 2023",
       size = "Minimum
...
(Pounds)") + 
  ...
  #set colour of axis line, as a shade of dark purple, set size
